"""blueproperty.gr scraper (Kefalidis Real Estate).

Site: Kefalidis Real Estate (https://www.blueproperty.gr)
...
(blueproperty, ergon_real_estate, kanata_realestate) unlocked.
...
Inventory: ~74 sale listings ≥€400k in Halkidiki across 3 categories: residential (50, 6 pages), commercial (10, 2 pages), land (14, 2 pages).
"""
...
# Constants
# ============================================================================
_SOURCE_DOMAIN = "blueproperty.gr"
_BASE_URL = "https://www.blueproperty.gr"
_CATEGORIES = ("residential", "commercial", "land")
_SEARCH_URL_TEMPLATE = (
    "https://www.blueproperty.gr/en/property/search"
...
# Scraper
# ============================================================================
class BluepropertyScraper(EnrichmentMixin, BaseScraper):
            ...
            for category in _CATEGORIES:
                ...
                while page_num <= max_pages:
                    ...
                    for (const a of document.querySelectorAll('a.property-item')) {
                        ...
                        out.push({
                            url: href.startsWith('http') ? href : ('https://www.blueproperty.gr' + href),
    ...
    def _parse_agent(self, parser, extras: Dict[str, Any]) -> None:
        ...
        extras["agent_company"] = "KYMAPROPERTY"
        extras["agent_email"] = "info@blueproperty.gr"
