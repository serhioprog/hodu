"""greece-halkidiki.com scraper (Kefalidis Real Estate).

Site: Kefalidis Real Estate (https://www.greece-halkidiki.com)
...
(greece_halkidiki, ergon_real_estate, greece_halkidiki) unlocked.
...
# Constants
# ============================================================================
_SOURCE_DOMAIN = "greece-halkidiki.com"
_BASE_URL = "https://www.greece-halkidiki.com"
_CATEGORIES = ("residential", "commercial", "land")
_SEARCH_URL_TEMPLATE = (
    "https://www.greece-halkidiki.com/en/property/search"
...
# Scraper
# ============================================================================
class GreeceHalkidikiScraper(EnrichmentMixin, BaseScraper):
    """Kefalidis Real Estate scraper (Camoufox-based, PerimeterX bypass)."""

    name = "greece_halkidiki"
            ...
            for category in _CATEGORIES:
                ...
                while page_num <= max_pages:
                    ...
                    for (const card of document.querySelectorAll('.listing-item')) {
                        ...
                        out.push({
                            url: href.startsWith('http') ? href : ('https://www.greece-halkidiki.com' + href),
    ...
    def _parse_agent(self, parser, extras: Dict[str, Any]) -> None:
        ...
        extras["agent_company"] = "kefalidis stefanos"
        extras["agent_email"] = "kefalidis.s@gmail.com"
