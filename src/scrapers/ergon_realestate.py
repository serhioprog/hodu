"""ergonrealestate.com scraper (Kefalidis Real Estate).

Site: Kefalidis Real Estate (https://www.ergonrealestate.com)
...
(ergon_realestate, ergon_real_estate, ergon_realestate) unlocked.
...
# Constants
# ============================================================================
_SOURCE_DOMAIN = "ergonrealestate.com"
_BASE_URL = "https://www.ergonrealestate.com"
_CATEGORIES = ("residential", "commercial", "land")
_SEARCH_URL_TEMPLATE = (
    "https://www.ergonrealestate.com/en/property/search"
...
# Scraper
# ============================================================================
class ErgonRealestateScraper(EnrichmentMixin, BaseScraper):
    """Kefalidis Real Estate scraper (Camoufox-based, PerimeterX bypass)."""

    name = "ergon_realestate"
            ...
            for category in _CATEGORIES:
                ...
                while page_num <= max_pages:
                    ...
                    for (const card of document.querySelectorAll('.listing-item')) {
                        ...
                        out.push({
                            url: href.startsWith('http') ? href : ('https://www.ergonrealestate.com' + href),
    ...
    def _parse_agent(self, parser, extras: Dict[str, Any]) -> None:
        ...
        extras["agent_company"] = "Ergon Real Estate"
        extras["agent_email"] = "hatzivaso@gmail.com"
