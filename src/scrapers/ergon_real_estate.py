"""
~/hodu/src/scrapers/ergon_real_estate.py

Ergon Real Estate (ergonrealestate.com) — Spitogatos-based agent website
...
def _to_int_euro_en(text: str) -> Optional[int]:
    """
    Parse ergonrealestate.com price strings (English locale: comma = thousand sep).
...
class ErgonRealEstateScraper(EnrichmentMixin, BaseScraper):
    """
    ergonrealestate.com — Spitogatos agentwebsite/template5.
