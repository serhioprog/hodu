"""halkidikiagency.gr scraper (Kefalidis Real Estate).

Site: Kefalidis Real Estate (https://www.halkidikiagency.gr)
...
(halkidikiagency, ergon_real_estate, kanata_realestate) unlocked.
...
Inventory: ~191 sale listings ≥€400k in Halkidiki across 3 categories: residential (84, 10 pages), commercial (33, 4 pages), land (74, 9 pages).
"""
...
_SEARCH_URL_TEMPLATE = (
    "https://www.halkidikiagency.gr/en/property/search"
...
class HalkidikiagencyScraper(EnrichmentMixin, BaseScraper):
            ...
            for category in _CATEGORIES:
                ...
                while page_num <= max_pages:
                    ...
                    for (const a of document.querySelectorAll('a.property-item')) {
                        ...
                        out.push({
                            url: href.startsWith('http') ? href : ('https://www.halkidikiagency.gr' + href),
    ...
    def _parse_agent(self, parser, extras: Dict[str, Any]) -> None:
        ...
        extras["agent_company"] = "Halkidiki Agency"
        extras["agent_email"] = "info@halkidikiagency.gr"
