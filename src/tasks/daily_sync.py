...
from src.scrapers.kassandra_estate import KassandraEstateScraper
...
from src.scrapers.ergon_realestate import ErgonRealestateScraper
...
async def _run_scrapers(global_stats: Dict[str, int]) -> List[DomainSyncReport]:
    ...
    active_scrapers = [
        ...
        ErgonRealestateScraper(),      # Camoufox-based, 3 categories (Ergon Real Estate, kanata template)
    ]
